...
public class DebugQuestionFragment extends Fragment {
    private View v;
    private int index;
    private Question q;
    public DebugQuestionFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_debug_question, container, false);
    ...
    public void updateUI() {
        ...
        ConstraintLayout constraintLayout = (ConstraintLayout) v.findViewById(R.id.alku);
